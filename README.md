# Buy Down Power — Deployment Checklist
...
3. **Verify your sending domain in Resend**
   Log in to resend.com and verify `buydownpower.com` so `leads@buydownpower.com` is authorized to send.
...
`🏠 New Lead: [Name] — [Loan Type] — buydownpower.com`
